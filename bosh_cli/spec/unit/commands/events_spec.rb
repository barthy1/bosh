    ...
    let(:event_1) do
      {
          ...
          "task_id"      => 1,
          "timestamp"    => "2016-02-15 12:53:21 -0800",
      }
    end
    let(:event_2) do
      {
          ...
          "task_id"      => 1,
          "timestamp"    => "2016-02-15 13:53:21 -0800",
      }
    end
...
+---+---------------------+--------+---------+---------------------+------+---------------------------+
| 1 | 'simple' deployment | create | started | running             | 1    | 2016-02-15 12:53:21 -0800 |
| 2 | 'simple' deployment | create | done    | /deployments/simple | 1    | 2016-02-15 13:53:21 -0800 |
+---+---------------------+--------+---------+---------------------+------+---------------------------+
"
        end
        command.list
